...
export const CAMPAIGN_MISSIONS: CampaignMissionDef[] = [
  ...
  },
  {
    ...
    description: 'A town-center-less field battle on the road to Prague.',
    briefing:
      '8 November 1620. Christian of Anhalt has drawn the Bohemian Estates onto the White Mountain plateau west of Prague. Hold the pass with infantry and cannon, then break Tilly and Bucquoy’s Imperial-Catholic League field army before Prague is lost.',
